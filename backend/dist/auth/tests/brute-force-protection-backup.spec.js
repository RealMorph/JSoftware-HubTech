...
describe('AuthService - Brute Force Protection', () => {
    ...
    describe('Account Lockout', () => {
        it('should implement account lockout after multiple failed login attempts', async () => {
            ...
            attemptsBeforeLockout.forEach(attempt => {
                ...
                expect(attempt.error).toBeInstanceOf(common_1.UnauthorizedException);
            });
            ...
            expect(lastAttempt.error).toBeInstanceOf(common_1.ForbiddenException);
    ...
    describe('CAPTCHA Challenge', () => {
        it('should implement CAPTCHA challenges for suspicious login attempts', async () => {
            ...
            service.login = jest.fn().mockImplementation(async (email, password, options) => {
            ...
            expect(captchaResult.requiresCaptcha).toBe(true);
    ...
    describe('Username Enumeration Prevention', () => {
        ...
        it('should prevent username enumeration during password reset', async () => {
            ...
            expect(existingResult.message).toBe('If your email exists in our system, you will receive a password reset link');
            const nonExistentResult = await service.requestPasswordReset('non-existent@example.com');
            expect(nonExistentResult.message).toBe('If your email exists in our system, you will receive a password reset link');
        });
    });
});
//# sourceMappingURL=brute-force-protection-backup.spec.js.map
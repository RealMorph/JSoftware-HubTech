    ...
    <div style={{ 
      ...
      <header style={{ 
        ...
        <nav style={{ display: 'flex', gap: '24px' }}>
          <a href="#" style={{ color: '#0073ea', textDecoration: 'none', fontWeight: 500 }}>Home</a>
          <a href="#" style={{ color: '#676879', textDecoration: 'none', fontWeight: 500 }}>Documentation</a>
          <a href="#" style={{ color: '#676879', textDecoration: 'none', fontWeight: 500 }}>Theme</a>
        </nav>
      </header>
        ...
        onMouseOut={(e) => {
          ...
          <div style={{ padding: '24px 20px 20px' }}>
            ...
            <p style={{ 
              ...
              Charts, graphs, maps and other visualization components for displaying data-driven insights.
            </p>
            <Link 
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          This component library is designed to provide a modern, consistent UI for building web applications.
          All components are built with React and follow best practices for accessibility and performance.
        </p>
        <div style={{
          display: 'flex',
          gap: '16px',

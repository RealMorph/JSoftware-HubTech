  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <section>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          ...
          <Card
            ...
            style={{ width: '300px' }}
            footer={
              <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Last updated: April 8, 2023</div>
            }
          >
      ...
      <section>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <Card title="Default Variant" variant="default" style={{ width: '200px' }}>
            <p>Standard card styling.</p>
          </Card>

          <Card title="Primary Variant" variant="primary" style={{ width: '200px' }}>
            <p>Primary colored card.</p>
          </Card>

          <Card title="Secondary Variant" variant="secondary" style={{ width: '200px' }}>
            <p>Secondary colored card.</p>
          </Card>

          <Card title="Accent Variant" variant="accent" style={{ width: '200px' }}>
      ...
      <section>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          ...
          <Card
            ...
            style={{ width: '350px' }}
            footer={
              <div style={{ fontSize: '0.8rem', textAlign: 'right' }}>Updated 5 minutes ago</div>
            }
          >
            <div>

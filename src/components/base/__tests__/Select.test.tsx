...
describe('Select Component', () => {
  ...
  test('handles selection changes', () => {
    ...
    renderWithTheme(<Select label="Test Select" options={options} onChange={handleChange} />);
  ...
  test('renders helper text when provided', () => {
    renderWithTheme(
      <Select label="Test Select" options={options} helperText="This is helper text" />
    );
  ...
  test('applies error styling when error prop is true', () => {
    renderWithTheme(
      <Select label="Test Select" options={options} error helperText="Error message" />
    );
  ...
  test('renders with placeholder', () => {
    renderWithTheme(
      <Select label="Test Select" options={options} placeholder="Select an option" />
    );
  ...
  test('renders as disabled when disabled prop is true', () => {
    renderWithTheme(<Select label="Test Select" options={options} disabled />);

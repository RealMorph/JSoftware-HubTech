...
describe('Panel Component', () => {
  ...
  test('renders different panel variants', () => {
    render(
      <ThemeWrapper>
        <Panel data-testid="default-panel" variant="default">Default Panel</Panel>
        <Panel data-testid="outlined-panel" variant="outlined">Outlined Panel</Panel>
        <Panel data-testid="flat-panel" variant="flat">Flat Panel</Panel>
      </ThemeWrapper>
    );
    ...
    // Default has shadow
    expect(defaultPanel).toHaveStyle('box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1),0 1px 2px 0 rgba(0, 0, 0, 0.06)');
  ...
  test('renders panel with different padding sizes', () => {
    render(
      <ThemeWrapper>
        <Panel data-testid="none-padding" padding="none">No Padding</Panel>
        <Panel data-testid="small-padding" padding="small">Small Padding</Panel>
        <Panel data-testid="medium-padding" padding="medium">Medium Padding</Panel>
        <Panel data-testid="large-padding" padding="large">Large Padding</Panel>
      </ThemeWrapper>
    );
  ...
  test('renders panel with full width and height', () => {
    render(
      <ThemeWrapper>
        <Panel data-testid="full-width" fullWidth>Full Width</Panel>
        <Panel data-testid="full-height" fullHeight>Full Height</Panel>
      </ThemeWrapper>
    );
  ...
  test('renders PanelHeader with divider', () => {
    render(
      <ThemeWrapper>
        <Panel>
          <PanelHeader data-testid="panel-header" divider>Header with Divider</PanelHeader>
        </Panel>
      </ThemeWrapper>
    );
  ...
  test('renders PanelFooter with divider', () => {
    render(
      <ThemeWrapper>
        <Panel>
          <PanelFooter data-testid="panel-footer" divider>Footer with Divider</PanelFooter>
        </Panel>
      </ThemeWrapper>
    );

...
describe('Container Component', () => {
  ...
  test('renders container with children', () => {
    renderWithTheme(<Container data-testid="container">Container Content</Container>);
  ...
  test('applies different horizontal and vertical padding', () => {
    renderWithTheme(
      <Container data-testid="container" paddingX="lg" paddingY="sm">
        Content
      </Container>
    );
  ...
  test('disables centering when center is false', () => {
    renderWithTheme(
      <Container data-testid="container" center={false}>
        Content
      </Container>
    );

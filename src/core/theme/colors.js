...
export const getColor = key => {
  ...
  if (category in semanticColors && shade in semanticColors[category]) {
    return semanticColors[category][shade];
  }
  if (category in stateColors && shade in stateColors[category]) {
    return stateColors[category][shade];
  }
  if (category in colors && shade in colors[category]) {

...
import { ThemeConfig, TypographyConfig, SpacingConfig, ThemeColors, BorderRadiusConfig, ShadowConfig, TransitionConfig } from './consolidated-types';
...
export function adaptThemeForEmotion(themeConfig: ThemeConfig): any {
  ...
  const textColors = typeof themeConfig.colors.text === 'string'
    ? { primary: themeConfig.colors.text, secondary: themeConfig.colors.text, disabled: themeConfig.colors.text }
  ...
  return {
    ...
    colors: {
      ...
      background: typeof themeConfig.colors.background === 'string'
...
export function adaptEmotionTheme(emotionTheme: Theme | any): ThemeConfig {
  ...
  return {
    colors: {
      ...
      secondary: emotionTheme.colors.secondary?.DEFAULT || emotionTheme.colors.secondary || '#9c27b0',
    ...
    typography: {
      fontFamily: {
        base: emotionTheme.typography?.fontFamily?.base || 
              emotionTheme.typography?.family?.primary || 
              'system-ui, sans-serif',
        heading: emotionTheme.typography?.fontFamily?.heading || 
                emotionTheme.typography?.family?.secondary || 
                'system-ui, sans-serif',
        monospace: emotionTheme.typography?.fontFamily?.monospace || 
                  emotionTheme.typography?.family?.monospace || 
                  'ui-monospace, monospace',
      },
      fontSize: emotionTheme.typography?.fontSize || emotionTheme.typography?.scale || {
        xs: '0.75rem',
        sm: '0.875rem',
        md: '1rem',
        lg: '1.125rem',
      ...
      fontWeight: emotionTheme.typography?.fontWeight || emotionTheme.typography?.weights || {
        light: 300,
        normal: 400,
        medium: 500,
        semibold: 600,
      ...
      lineHeight: emotionTheme.typography?.lineHeight || emotionTheme.typography?.lineHeights || {
        none: 1,
        tight: 1.25,
        normal: 1.5,
        relaxed: 1.75,
    ...
    transitions: {
      duration: {
        ...
        normal: emotionTheme.transitions?.duration?.normal || emotionTheme.transitions?.normal || '300ms',
 ...
 */
export function getThemeColor(theme: ThemeConfig | Theme, colorPath: string, fallback: string = '#000000'): string {
 ...
 */
export function getThemeTypography(theme: ThemeConfig | Theme, typographyPath: string, fallback?: string | number): string | number {
 ...
 */
export function getThemeSpacing(theme: ThemeConfig | Theme, key: string, fallback: string = '0'): string {

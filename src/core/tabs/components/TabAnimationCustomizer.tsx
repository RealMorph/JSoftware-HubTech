  ...
  return (
    <CustomizerContainer>
        ...
        <div>
          ...
          <ControlField>
            <Checkbox>
              ...
              />
              <ControlLabel htmlFor="enable-group-collapse">
                Enable Group Collapse Animation
              </ControlLabel>
            </Checkbox>
          </ControlField>
          ...
          <ControlField>
            <Checkbox>
              ...
              />
              <ControlLabel htmlFor="enable-drag-preview">
      ...
      <ButtonRow>
        ...
        <Button className="secondary" onClick={handleResetAnimations}>
          Reset to Default
        </Button>
      </ButtonRow>
    </CustomizerContainer>
